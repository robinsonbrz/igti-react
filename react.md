...
2.1. Introdução a TypeScript https://youtu.be/fhXaGnNeUXM

2.2. Aplicação React em TypeScript https://youtu.be/6wq2iHd6M14

2.3. Definição de tipos para os dados da aplicação https://youtu.be/_VMdDs2wRP0
